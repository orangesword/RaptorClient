package com.raptordev.raptor.api.clickgui.components.theme;
...
public class RainbowTheme implements Theme {
    ...
    public RainbowTheme (ColorScheme scheme, int height, Supplier<Boolean> ignoreDisabled, Supplier<Boolean> buttonRainbow) {
        this.scheme=scheme;
    ...
    protected class ComponentRenderer extends RendererBase {
        ...
        public ColorScheme getDefaultColorScheme() {
            return RainbowTheme.this.scheme;
        }
