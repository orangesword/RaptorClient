package com.raptordev.raptor.api.util.render;
...
public class RenderUtil {
    ...
    public static void drawLine(double posx, double posy, double posz, double posx2, double posy2, double posz2, RCColor color) {
    ...
    public static void drawLine(double posx, double posy, double posz, double posx2, double posy2, double posz2, RCColor color, float width) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        GlStateManager.glLineWidth(width);
        color.glColor();
    ...
    public static void draw2DRect(int posX, int posY, int width, int height, int zHeight, RCColor color) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        GlStateManager.enableBlend();
        GlStateManager.disableTexture2D();
    ...
    private static void drawBorderedRect(double x, double y, double x1, double y1, float lineWidth, RCColor inside, RCColor border) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        inside.glColor();
        bufferbuilder.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION);
    ...
    public static void drawBox(BlockPos blockPos, double height, RCColor color, int sides) {
        drawBox(blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1, height, 1, color, color.getAlpha(), sides);
    }

    public static void drawBox(AxisAlignedBB bb, boolean check, double height, RCColor color, int sides) {
        drawBox(bb, check, height, color, color.getAlpha(), sides);
    }

    public static void drawBox(AxisAlignedBB bb, boolean check, double height, RCColor color, int alpha, int sides) {
        if (check) {
    ...
    public static void drawBox(double x, double y, double z, double w, double h, double d, RCColor color, int alpha, int sides) {
    ...
    public static void drawBoundingBox(BlockPos bp, double height, float width, RCColor color) {
        drawBoundingBox(getBoundingBox(bp, 1, height, 1), width, color, color.getAlpha());
    }

    public static void drawBoundingBox(AxisAlignedBB bb, double width, RCColor color) {
        drawBoundingBox(bb, width, color, color.getAlpha());
    }

    public static void drawBoundingBox(AxisAlignedBB bb, double width, RCColor color, int alpha) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
    ...
    public static void drawBoundingBoxWithSides(BlockPos blockPos, int width, RCColor color, int sides) {
        drawBoundingBoxWithSides(getBoundingBox(blockPos, 1, 1, 1), width, color, color.getAlpha(), sides);
    }

    public static void drawBoundingBoxWithSides(BlockPos blockPos, int width, RCColor color, int alpha, int sides) {
        drawBoundingBoxWithSides(getBoundingBox(blockPos, 1, 1, 1), width, color, alpha, sides);
    }

    public static void drawBoundingBoxWithSides(AxisAlignedBB axisAlignedBB, int width, RCColor color, int sides) {
        drawBoundingBoxWithSides(axisAlignedBB, width, color, color.getAlpha(), sides);
    }

    public static void drawBoundingBoxWithSides(AxisAlignedBB axisAlignedBB, int width, RCColor color, int alpha, int sides) {
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        GlStateManager.glLineWidth(width);
        bufferbuilder.begin(GL11.GL_LINE_STRIP, DefaultVertexFormats.POSITION_COLOR);
    ...
    public static void drawBoxWithDirection(AxisAlignedBB bb, RCColor color, float rotation, float width, int mode) {
    ...
    public static void drawDirection(Points square, RCColor color, float width) {
        for (int i = 0; i < 4; i++) {
    ...
    public static void drawSphere(double x, double y, double z, float size, int slices, int stacks, float lineWidth, RCColor color) {
    ...
    public static void drawNametag(Entity entity, String[] text, RCColor color, int type) {
    ...
    public static void drawNametag(double x, double y, double z, String[] text, RCColor color, int type) {
        ...
        if (type == 2) {
            double width = 0;
            RCColor bcolor = new RCColor(0, 0, 0, 51);
            ...
            drawBorderedRect(-width - 1, -mc.fontRenderer.FONT_HEIGHT, width + 2, 1, 1.8f, new RCColor(0, 4, 0, 85), bcolor);
        }
        GlStateManager.enableTexture2D();
        for (int i = 0; i < text.length; i++) {
    ...
    private static void colorVertex(double x, double y, double z, RCColor color, int alpha, BufferBuilder bufferbuilder) {
    ...
    private static void doVerticies(AxisAlignedBB axisAlignedBB, RCColor color, int alpha, BufferBuilder bufferbuilder, int sides, boolean five) {
