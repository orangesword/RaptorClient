...
import com.raptordev.raptor.client.module.modules.client.hud.Notifications;
...
public class MessageBus {
    ...
    public static String watermark = ChatFormatting.GRAY + "[" + ChatFormatting.RED + "Raptor" + ChatFormatting.GREEN + "Client" + ChatFormatting.GRAY + "] " + ChatFormatting.RESET;
