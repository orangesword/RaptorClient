...
public class VersionChecker {
    ...
    public static void init() {
        checkVersion(RaptorClient.MODVER);
    }
    ...
    private static void checkVersion(String version) {
        ...
        try {
            URL url = new URL("https://raw.githubusercontent.com/RaptorClientDevelopment/RaptorAssets/main/version.txt");
    ...
    private static void generatePopUp(String newVersion) {
        ...
        JOptionPane.showMessageDialog(null, editorPane, RaptorClient.MODNAME + " " + RaptorClient.MODVER, JOptionPane.WARNING_MESSAGE);
    }
}