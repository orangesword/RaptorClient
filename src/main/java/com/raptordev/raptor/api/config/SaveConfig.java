...
import com.raptordev.raptor.api.util.player.social.Enemy;
import com.raptordev.raptor.api.util.player.social.Friend;
...
public class SaveConfig {
    ...
    private static void saveCustomFont() throws IOException {
        ...
        fontObject.add("Font Name", new JsonPrimitive(RaptorClient.INSTANCE.cFontRenderer.getFontName()));
        fontObject.add("Font Size", new JsonPrimitive(RaptorClient.INSTANCE.cFontRenderer.getFontSize()));
    ...
    private static void saveClickGUIPositions() throws IOException {
        ...
        RaptorClient.INSTANCE.raptorGUI.gui.saveConfig(new GuiConfig(fileName + mainName));
    }
