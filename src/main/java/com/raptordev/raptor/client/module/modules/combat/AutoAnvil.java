...
@Module.Declaration(name = "AutoAnvil", category = Category.Combat, Description = "Automatically traps and places anvils over opponents head to attempt to destroy their helmet")
