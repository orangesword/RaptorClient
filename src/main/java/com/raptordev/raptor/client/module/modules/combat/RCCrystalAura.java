...
import com.raptordev.raptor.api.util.combat.ac.*;
...
public class RCCrystalAura extends Module {
    ...
    ColorSetting color = registerColor("Color", new RCColor(0, 255, 0, 50));
    ...
    public void onWorldRender(RenderEvent event) {
        if (this.render != null) {
            RenderUtil.drawBox(this.render,1, new RCColor(color.getValue(),50), 63);
            RenderUtil.drawBoundingBox(this.render, 1, 1.00f, new RCColor(color.getValue(),255));
        }
        ...
        if(showDamage.getValue()) {
            if (this.render != null && this.renderEntity != null) {
                ...
                RenderUtil.drawNametag((double) render.getX() + 0.5d,(double) render.getY() + 0.5d,(double) render.getZ() + 0.5d, damageText, new RCColor(255,255,255),1);
            }
        }
    }
