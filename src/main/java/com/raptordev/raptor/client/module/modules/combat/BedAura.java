...
@Module.Declaration(name = "BedAura", category = Category.Combat, Description = "Automatically places and attempts to sleep in beds in the nether to explode opponent")
