...
@Module.Declaration(name = "PistonCrystal", category = Category.Combat, priority = 999, Description = "Places and extends a piston pushing a crystal into an opponents hole")
