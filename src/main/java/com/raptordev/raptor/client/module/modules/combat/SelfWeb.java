...
@Module.Declaration(name = "SelfWeb", category = Category.Combat, Description = "Places cobwebs in your own hole blocking opponents from easily entering at the expense of maneuverability ")
