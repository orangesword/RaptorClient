...
@Module.Declaration(name = "PistonAura", category = Category.Combat, priority = 999, Description = "Places and extends a piston pushing a crystal into an opponents hole")
