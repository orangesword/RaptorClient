...
public class CityESP extends Module {
    ...
    ColorSetting color = registerColor("Color", new RCColor(102, 51, 153));
    ...
    private void renderBox(BlockPos blockPos) {
        RCColor RCColor1 = new RCColor(color.getValue(), 255);
        RCColor RCColor2 = new RCColor(color.getValue(), 50);
